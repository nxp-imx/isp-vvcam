...
#include "vvsensor.h"
#define ar1335_4096_3072
/* 4096x2160@30fps RAW10 */
static struct vvsensor_ar1335_reg_value_t ar1335_init_setting_12MP[] = {
    ...
    {0x0306, 0x2D2D, 0, 0}, // PLL_MULTIPLIER
    ...
    {0x0344, 0x0048, 0, 0}, // X_ADDR_START
    {0x0348, 0x1047, 0, 0}, // X_ADDR_END
#ifdef ar1335_4096_3072
    {0x0346, 0x0004, 0, 0}, // Y_ADDR_START, 0x01F0(2160), 0x4(3072)
    {0x034A, 0x0C03, 0, 0}, // Y_ADDR_END, 0x0A5F(2160+Y_ADDR_START-1), 0xC03(3072+Y_ADDR_START-1)
    {0x034E, 0x0C00, 0, 0}, // Y_OUTPUT_SIZE, 0x0870(2160), 0xC00(3072)
#else
    {0x0346, 0x01F0, 0, 0}, // Y_ADDR_START
    {0x034A, 0x0A5F, 0, 0}, // Y_ADDR_END
    {0x034E, 0x0870, 0, 0}, // Y_OUTPUT_SIZE
#endif
    {0x034C, 0x1000, 0, 0}, // X_OUTPUT_SIZE
    ...
    {0x0340, 0x0C1C, 0, 0}, // FRAME_LENGTH_LINES
    {0x0202, 0x0C10, 0, 0}, // COARSE_INTEGRATION_TIME
    {0x0342, 0x1230, 0, 0}, // LINE_LENGTH_PCK
    {0x0340, 0x0C1C, 0, 0}, // FRAME_LENGTH_LINES
    {0x0202, 0x0C10, 0, 0}, // COARSE_INTEGRATION_TIME
    {0x30FE, 0x0060, 0, 0}, // CTREE_OFF
