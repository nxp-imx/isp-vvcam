...
struct vvsensor_ar1335_reg_value_t {
    uint16_t addr;
    uint16_t val;
    uint16_t mask;
    uint32_t delay;
...
/* 1080P60 RAW10 */
static struct vvsensor_ar1335_reg_value_t ar1335_init_setting_1080p60[] = {
    ...
    {0x31B0, 0x004D, 0, 0}, // FRAME_PREAMBLE
    {0x31B2, 0x0028, 0, 0}, // LINE_PREAMBLE
    {0x31B4, 0x230E, 0, 0}, // MIPI_TIMING_0
    {0x31B6, 0x1348, 0, 0}, // MIPI_TIMING_1
    {0x31B8, 0x1C12, 0, 0}, // MIPI_TIMING_2
    {0x31BA, 0x185B, 0, 0}, // MIPI_TIMING_3
    {0x31BC, 0x8509, 0, 0}, // MIPI_TIMING_4
    {0x0300, 0x0004, 0, 0}, // VT_PIX_CLK_DIV
    {0x0302, 0x0001, 0, 0}, // VT_SYS_CLK_DIV
    {0x0304, 0x0505, 0, 0}, // PRE_PLL_CLK_DIV
    {0x0306, 0xB7B7, 0, 0}, // PLL_MULTIPLIER
    ...
    {0x034A, 0x0A5D, 0, 0}, // Y_ADDR_END
    {0x034C, 0x0780, 0, 0}, // X_OUTPUT_SIZE
    {0x034E, 0x0438, 0, 0}, // Y_OUTPUT_SIZE
    {0x3040, 0x0043, 0, 0}, // READ_MODE
    {0x3172, 0x0206, 0, 0}, // ANALOG_CONTROL2
    {0x317A, 0x516E, 0, 0}, // ANALOG_CONTROL6
    {0x3F3C, 0x0003, 0, 0}, // ANALOG_CONTROL9
    {0x0400, 0x0001, 0, 0}, // SCALING_MODE
    {0x0404, 0x0020, 0, 0}, // SCALE_M
    {0x0342, 0x1230, 0, 0}, // LINE_LENGTH_PCK
    {0x0340, 0x0C4E, 0, 0}, // FRAME_LENGTH_LINES
    {0x0202, 0x0C4E, 0, 0}, // COARSE_INTEGRATION_TIME
    {0x30FE, 0x0060, 0, 0}, // CTREE_OFF
    {0x31E0, 0x0781, 0, 0}, // PIX_DEF_ID
    ...
    {0x0340, 0x0625, 0, 0}, // FRAME_LENGTH_LINES
    {0x0202, 0x0625, 0, 0}, // COARSE_INTEGRATION_TIME
    {0x3F3C, 0x0003, 0, 0}, // ANALOG_CONTROL9
